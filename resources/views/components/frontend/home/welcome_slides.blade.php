<section class="welcome_area">
    <div class="welcome_slides owl-carousel">
        <!-- Single Slide -->
        <div class="single_slide bg-img" style="background-image: url({{ asset('ui/frontend/assets/img/bg-img/8.jpg') }});">
                ...
                <div class="row h-100 align-items-center">
                    ...
                    <div class="col-5 col-md-4">
                        <div class="welcome_slide_image">
                            <img src="{{ asset('ui/frontend/assets/img/bg-img/slide-1.png') }}" alt="" data-animation="bounceInUp" data-delay="500ms">
        ...
        <!-- Single Slide -->
        <div class="single_slide bg-img" style="background-image: url({{ asset('ui/frontend/assets/img/bg-img/7.jpg') }});">
            <div class="container h-100">
                <div class="row h-100 align-items-center">
        ...
        <!-- Single Slide -->
        <div class="single_slide bg-img" style="background-image: url({{ asset('ui/frontend/assets/img/bg-img/6.jpg') }});">
            <div class="container h-100">
                <div class="row h-100 align-items-center">
