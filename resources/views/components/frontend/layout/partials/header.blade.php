            ...
            <div class="row h-100 align-items-center">
                <div class="col-6">
                    <div class="welcome-note">
                        ...
                        <span class="text" style="color: #7aac09;">Welcome to Amazing ecommerce.</span>
                    </div>
                </div>
                <div class="col-6">
        ...
        <div class="container">
            <div class="classy-nav-container breakpoint-off">
                <nav class="classy-navbar" id="bigshopNav">
                    ...
                    {{-- Nav Brand --}}
                    <a href="{{ route('home.index') }}" class="nav-brand"><img src="{{ asset('ui/frontend/assets/img/core-img/logo.png') }}" alt="logo"></a>
                                        ...
                                        <div class="single-mega cn-col-2">
                                            <div class="megamenu-slides owl-carousel">
                                                <a href="shop-grid-left-sidebar.html">
                                                    <img src="{{ asset('ui/frontend/assets/img/bg-img/mega-slide-2.jpg') }}" alt="">
                                                </a>
                                                <a href="shop-list-left-sidebar.html">
                                                    <img src="{{ asset('ui/frontend/assets/img/bg-img/mega-slide-1.jpg') }}" alt="">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="hero_meta_area ml-auto d-flex align-items-center justify-content-end">
                                ...
                                <ul class="cart-list">
                                    <li>
                                        <div class="cart-item-desc">
                                            <a href="#" class="image">
                                                <img src="{{ asset('ui/frontend/assets/img/product-img/top-1.png') }}" class="cart-thumb" alt="">
                                            </a>
                                            <div>
                                                <a href="#">Kid&#39; Fashion</a>
                                    ...
                                    <li>
                                        <div class="cart-item-desc">
                                            <a href="#" class="image">
                                                <img src="{{ asset('ui/frontend/assets/img/product-img/best-4.png') }}" class="cart-thumb" alt="">
                                            </a>
                                            <div>
                                                <a href="#">Headphone</a>
                        ...
                        {{--  <div class="account-area">
                            <div class="user-thumbnail">
                                <img src="{{ asset('ui/frontend/assets/img/bg-img/user.jpg') }}" alt="">
                            </div>
